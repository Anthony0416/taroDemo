...
export default class party extends Component {
  ...
  render () {
    ...
    return (
      <View className='party' onTouchStart={this.touchEvent} onTouchMove={this.touchEvent} onTouchEnd={this.touchEvent}>
        <Text className={`times ${countDown ? null : 'none'}`}>{countDown}</Text>
        <View className={`startBtn ${countDown ? 'none' : null}`} onClick={this.startEvent}>开始</View>
